...
export const GeminiSparkle: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <div className={`${className} bg-gradient-to-tr from-indigo-500 to-purple-500 rounded-full flex items-center justify-center text-[10px] text-white`}>
    ✦
  </div>
);
